...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            {'position_idx': 1, 'grasp_type': 2, 'dimension': 0.04, 'parameters': 0.045},
            #{'position_idx': 2, 'grasp_type': 1, 'dimension': 0.015, 'parameters': 0.035},
            {'position_idx': 3, 'grasp_type': 2, 'dimension': 0.0425, 'parameters': 0.045},
            #{'position_idx': 4, 'grasp_type': 1, 'dimension': 0.0225, 'parameters': 0.035},
            {'position_idx': 5, 'grasp_type': 2, 'dimension': 0.045, 'parameters': 0.045},
