    ...
    def __init__(self):
        ...
        self.grasp_type_configs = {
            1: {  # medium wrap
                ...
                'translation_noise_offset': [0.0, 0.0, -0.015],
                'orientation_noise_offset': [0.0, 0.0, 30.0]  # [yaw, pitch, roll] in degrees
            },
            2: {  # power sphere
                'dimension_noise_is_fixed': True,
                'fixed_dimension_noise': 0.0,
                'std_dimension_noise': 0.0,
                'position_noise_enabled': True,
                'translation_noise_offset': [0.0, -0.05, 0.0],
            ...
            3: {  # lateral pinch
                ...
                'std_dimension_noise': 0.0,
                'position_noise_enabled': True,
                'translation_noise_offset': [0.0, 0.0, 0.03],
                'orientation_noise_offset': [0.0, 0.0, 0.0]
            }
        }
