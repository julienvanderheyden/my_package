...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            ...
            {'position_idx': 2, 'grasp_type': 1, 'dimension': 0.02, 'parameters': 0.02},
            {'position_idx': 3, 'grasp_type': 1, 'dimension': 0.01, 'parameters': 0.01},
            {'position_idx': 4, 'grasp_type': 1, 'dimension': 0.001, 'parameters': 0.001},
