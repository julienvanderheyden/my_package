...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            ...
            {'position_idx': 2, 'grasp_type': 1, 'dimension': 0.0225, 'parameters': 0.0225},
            {'position_idx': 3, 'grasp_type': 1, 'dimension': 0.0375, 'parameters': 0.0375},
            {'position_idx': 4, 'grasp_type': 1, 'dimension': 0.0275, 'parameters': 0.0275},
            {'position_idx': 5, 'grasp_type': 1, 'dimension': 0.01, 'parameters': 0.01},
