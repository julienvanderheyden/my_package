...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            {'position_idx': 1, 'grasp_type': 2, 'dimension': 0.025, 'parameters': 0.03},
            ...
            {'position_idx': 5, 'grasp_type': 2, 'dimension': 0.0325, 'parameters': 0.03},
            ...
            {'position_idx': 9, 'grasp_type': 2, 'dimension': 0.0375, 'parameters': 0.03},
        ]
