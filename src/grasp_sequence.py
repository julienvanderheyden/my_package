...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            ...
            {'position_idx': 1, 'grasp_type': 3, 'dimension': [0.03, 0.0125], 'parameters': [0.03, 0.0125]},
            {'position_idx': 2, 'grasp_type': 3, 'dimension': [0.035, 0.015], 'parameters': [0.035, 0.015]},
            {'position_idx': 3, 'grasp_type': 3, 'dimension': [0.035, 0.01], 'parameters': [0.035, 0.01]},
