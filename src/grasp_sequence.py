...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            {'position_idx': 1, 'grasp_type': 2, 'dimension': 0.02, 'parameters': 0.03},
            ...
            {'position_idx': 5, 'grasp_type': 2, 'dimension': 0.03, 'parameters': 0.03},
            ...
            {'position_idx': 9, 'grasp_type': 2, 'dimension': 0.04, 'parameters': 0.03},
        ]
