...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            ...
            {'position_idx': 3, 'grasp_type': 1, 'dimension': 0.0225, 'parameters': 0.0225},
            {'position_idx': 4, 'grasp_type': 1, 'dimension': 0.015, 'parameters': 0.015},
            ...
            {'position_idx': 9, 'grasp_type': 1, 'dimension': 0.02, 'parameters': 0.02},
            {'position_idx': 10, 'grasp_type': 1, 'dimension': 0.015, 'parameters': 0.015},
            {'position_idx': 11, 'grasp_type': 1, 'dimension': 0.0375, 'parameters': 0.0375},
