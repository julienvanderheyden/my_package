...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.grasp_sequence = [
            {'position_idx': 1, 'grasp_type': 3, 'dimension': [0.0375, 0.001], 'parameters': [0.0375, 0.001]},
            {'position_idx': 2, 'grasp_type': 3, 'dimension': [0.0375, 0.005], 'parameters': [0.0375, 0.005]},
            {'position_idx': 3, 'grasp_type': 3, 'dimension': [0.0375, 0.0075], 'parameters': [0.0375, 0.0075]},
            ...
            {'position_idx': 6, 'grasp_type': 3, 'dimension': [0.0375, 0.015], 'parameters': [0.0375, 0.015]},
            {'position_idx': 7, 'grasp_type': 3, 'dimension': [0.0375, 0.0175], 'parameters': [0.0375, 0.0175]},
            {'position_idx': 8, 'grasp_type': 3, 'dimension': [0.0375, 0.02], 'parameters': [0.0375, 0.02]},
            {'position_idx': 9, 'grasp_type': 3, 'dimension': [0.0375, 0.0225], 'parameters': [0.0375, 0.0225]},
        ...
        # self.grasp_sequence = [
            ...
            # {'position_idx': 2, 'grasp_type': 3, 'dimension': [0.035, 0.01], 'parameters': [0.035, 0.01]},
            # {'position_idx': 3, 'grasp_type': 3, 'dimension': [0.0375, 0.02], 'parameters': [0.0375, 0.02]},
            # {'position_idx': 4, 'grasp_type': 3, 'dimension': [0.035, 0.025], 'parameters': [0.035, 0.025]},
            # {'position_idx': 5, 'grasp_type': 1, 'dimension': 0.035, 'parameters': 0.035},
            # {'position_idx': 6, 'grasp_type': 1, 'dimension': 0.0375, 'parameters': 0.0375},
            # {'position_idx': 7, 'grasp_type': 1, 'dimension': 0.0225, 'parameters': 0.0225},
            # {'position_idx': 8, 'grasp_type': 1, 'dimension': 0.0225, 'parameters': 0.0225},
            # {'position_idx': 9, 'grasp_type': 1, 'dimension': 0.0375, 'parameters': 0.0375},
            # {'position_idx': 10, 'grasp_type': 1, 'dimension': 0.02, 'parameters': 0.02},
            # {'position_idx': 11, 'grasp_type': 1, 'dimension': 0.03, 'parameters': 0.03},
    ...
    def compute_palm_position(self, ref_position, dim, param, grasp_type, ref_idx):
        ...
        if grasp_type == 1:  # medium wrap
            ...
            if top_approach : #for generalization test only 
                ...
                z = ref_position[2] + top_stand_height + 2*radius 
                y = ref_position[1] - 0.03
                x = ref_position[0] - 0.083
            else : 
