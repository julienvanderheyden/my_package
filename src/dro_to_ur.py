...
def main():
    ...
    test_cylinder_5cm = np.array([[-0.1268, 0.2798, 0.1701, 1.5827, 0.2907, -0.0789, 0.1162, 0.3488, -0.349, 0.5263, 0.4096, 0.4739, 
    -0.2786, 0.5435, 0.5087, 0.4328, -0.1559, 0.939, 0.307, 0.8539, 0.3694, -0.3492, 1.0359, 0.0217, 1.5299, -0.4739, 0.6685, 0.2094, 
    0.2943, 0.4474], [-0.1268, 0.2798, 0.1701, 1.5827, 0.2907, -0.0789, 0.1162, 0.3488, -0.1745, 0.3293, 0.3072, 0.3554, -0.1217, 0.3421, 
    0.3815, 0.3246, -0.2042, 0.6388, 0.2302, 1.0332, 0.2771, -0.3491, 0.7115, 0.0163, 1.5402, -0.6172, 0.5013, 0.1047, 0.0462, 0.2701], 
    [-0.1268, 0.2798, 0.1701, 1.5827, 0.2907, -0.0789, 0.1162, 0.3488, -0.349, 0.683, 0.5838, 0.6385, -0.2892, 0.6976, 0.668, 0.6035, 
     -0.0802, 1.0338, 0.4966, 0.7259, 0.4318, -0.2444, 1.1161, 0.2541, 1.3004, -0.2457, 0.7515, 0.2094, 0.3549, 0.6159]])
    ...
    object_xyz = [1.279, 0.14, 0.74+0.085]  # object centroid in world frame (metres)
