...
def main():
    ...
    grasps = np.array([[-0.2876,  0.1435, -0.0800,  1.1954,  0.7821,  1.8741, -0.1296,  0.4338,
         0.3491, -0.2618,  1.4403,  0.6618,  0.1943, -0.1911,  1.4831,  0.7227,
         0.0259,  0.1337,  1.2837,  0.4814,  0.1814,  0.2379,  0.8597,  0.2772,
         0.4288,  0.8897,  1.2217,  0.2094, -0.6981, -0.2618],
        [-0.2876,  0.1435, -0.0800,  1.1954,  0.7821,  1.8741, -0.1296,  0.4338,
         0.1745, -0.2618,  1.0803,  0.4963,  0.0584, -0.2087,  1.1124,  0.5420,
        -0.0679,  0.0348,  0.9628,  0.3611,  0.1361,  0.0912,  0.5794,  0.2079,
         0.3216,  0.4055,  1.2217,  0.2094, -0.6981, -0.2618],
        [-0.2876,  0.1435, -0.0800,  1.1954,  0.7821,  1.8741, -0.1296,  0.4338,
         0.3491,  0.0131,  1.4599,  0.7981,  0.2175,  0.0732,  1.4963,  0.8499,
         0.0744,  0.3492,  1.3267,  0.6448,  0.2720,  0.2546,  0.9664,  0.4712,
         0.6001,  0.9133,  1.0385,  0.1466, -0.4887,  0.0131]], dtype=float)
