...
def main():
    ...
    test_cylinder_5cm = np.array([[-0.2882, -0.1715, 0.1283, 4.0762, 0.9492, -1.3219, -0.1412, -0.6527, -0.2066, 0.3092, 0.549, 1.0302, 
                                   -0.3491, 0.4492, 0.2708, 0.8023, 0.349, 0.4695, 0.9624, 0.1601, 0.6011, -0.0237, 1.1306, 0.0, 0.9634, 
                                   0.0616, 1.2217, -0.1925, -0.5124, 0.888], [-0.2882, -0.1715, 0.1283, 4.0762, 0.9492, -1.3219, -0.1412, 
                                    -0.6527, -0.2422, 0.1664, 0.4118, 0.7727, -0.1745, 0.2715, 0.2031, 0.6017, 0.1745, 0.2867, 0.7218, 0.1201, 
                                    0.4509, -0.105, 0.7825, 0.0, 0.7226, -0.2156, 1.2217, -0.092, -0.5589, 0.6006], [-0.2882, -0.1715, 0.1283, 
                                    4.0762, 0.9492, -1.3219, -0.1412, -0.6527, -0.1233, 0.4984, 0.7023, 1.1113, -0.3491, 0.6175, 0.4658, 0.9176, 
                                    0.3491, 0.6347, 1.0537, 0.3717, 0.6288, 0.0322, 1.1966, 0.2356, 1.0545, 0.2094, 1.0385, -0.195, -0.3309, 0.9904]])
