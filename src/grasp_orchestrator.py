...
class GraspOrchestrator:
    def __init__(self):
        ...
        self.parameters = [0.035, 0.035, 0.035, 0.035, 0.035, 0.035, 0.035, 0.035, 0.035] 
        ...
        self.fixed_dimension_noise = -0.75
        ...
        if self.grasp_type == 2 : #power sphere
            self.reference_positions = [
                ...
                [1.268, 0.738, 0.78], #left most position
                [1.268, 0.499, 0.78],
                [1.268, 0.258, 0.78],
                [1.268, 0.023, 0.78],
                [1.268, -0.219, 0.78]] # right most position
        else :
            self.reference_positions = [
                [0.90, 0.173, 1.07],     # 0: home
                [1.268, 0.738, 0.78],   # 1: leftmost
                [1.268, 0.618, 0.78],   # 2
                [1.268, 0.499, 0.78],   # 3
                [1.268, 0.379, 0.78],   # 4
                [1.268, 0.258, 0.78],   # 5
